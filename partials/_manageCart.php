    ...
    if(isset($_POST['checkout'])) {
        ...
        if (password_verify($password, $passRow['password'])){ 
            ...
            if ($result){
                ...
                echo '<script>alert("Cảm ơn đã đặt hàng với chúng tôi, ID đơn hàng của bạn là ' .$orderId. '.");
            ...
            echo '<script>alert("Mật khẩu không đúng! Vui lòng nhập mật khẩu chính xác.");
                    window.history.back(1);
                    </script>';
                    exit();
        }    
