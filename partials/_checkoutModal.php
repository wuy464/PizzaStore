...
<div class="modal fade" id="checkoutModal" tabindex="-1" role="dialog" aria-labelledby="checkoutModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="checkoutModal">Nhập thông tin chi tiết:</h5>
        ...
        <div class="modal-body">
            <form action="partials/_manageCart.php" method="post">
                <div class="form-group">
                    ...
                    <input class="form-control" id="address" name="address" placeholder="1234 Trường Sa" type="text" required minlength="3" maxlength="500">
                </div>
                <div class="form-group">
                    <b><label for="address1">Địa chỉ (gần đây):</label></b>
                    <input class="form-control" id="address1" name="address1" placeholder="16 Trường Sa, trường Bình Thạnh" type="text">
                </div>
                <div class="form-row">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="checkout" class="btn btn-success">Đặt</button>
                </div>
            </form>
        </div>
        </div>
