			...
			<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
				<div class="card mb-3">
					...
					<div class="card-footer">
						<div class="row">
							<div class="mx-auto">
								<button type="submit" name="createItem" class="btn btn-sm btn-primary"> Tạo </button>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover mb-0">
							<thead style="background-color: rgb(111 202 203);">
								<tr>
									<th class="text-center" style="width:7%;">ID Loại</th>
									<th class="text-center">Ảnh</th>
									<th class="text-center" style="width:58%;">Chi tiết</th>
									<th class="text-center" style="width:18%;">Thực hiện</th>
								</tr>
							</thead>
							<tbody>
                            <?php
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    echo '<tr>
                                            ...
                                            <td>
                                                <img src="/OnlinePizzaDelivery/img/pizza-'.$pizzaId. '.jpg" alt="Ảnh cho thực đơn này" width="150px" height="150px">
                                            </td>
                                            <td>
                                                <p>Tên món: <b>' .$pizzaName. '</b></p>
                                                <p>Mô tả: <b class="truncate">' .$pizzaDesc. '</b></p>
                                                <p>Giá: <b>' .$pizzaPrice. '$</b></p>
                                            </td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: rgb(111 202 203);">
        <h5 class="modal-title" id="updateItem<?php echo $pizzaId; ?>">ID thực đơn: <?php echo $pizzaId; ?></h5>
	  	...
	  	<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
		    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
		   		<div class="form-group col-md-8">
					...
					<small id="Info" class="form-text text-muted mx-3">.</small>
					<input type="hidden" id="pizzaId" name="pizzaId" value="<?php echo $pizzaId; ?>">
					<button type="submit" class="btn btn-success my-1" name="updateItemPhoto">Update ảnh</button>
				</div>
