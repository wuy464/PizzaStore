...
<div class="container-fluid" style="margin-top:98px">
	...
	<div class="row">
        <div class="col-lg-12">
            <button class="btn btn-primary float-right btn-sm" data-toggle="modal" data-target="#newUser"><i class="fa fa-plus"></i> Thêm người dùng mới</button>
        </div>
	</div>
	    <br>
	<div class="row">
                    ...
                    <tbody>
                        <?php
                            ...
                            while($row=mysqli_fetch_assoc($result)) {
                                ...
                                echo '<tr>
                                    <td>' .$Id. '</td>
                                    <td><img src="/OnlinePizzaDelivery/img/person-' .$Id. '.jpg" alt="Ảnh từ khách hàng" onError="this.src =\'/OnlinePizzaDelivery/img/profilePic.jpg\'" width="100px" height="100px"></td>
                                    <td>' .$username. '</td>
                                    <td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: rgb(111 202 203);">
        <h5 class="modal-title" id="newUser">Tạo người dùng mới</h5>
      ...
      <div class="modal-body">
        <form action="partials/_userManage.php" method="post">
              <div class="form-group">
                  ...
                  <input class="form-control" id="username" name="username" placeholder="Nhập tên tài khoản (không được trùng)" type="text" required minlength="3" maxlength="11">
              </div>
              <div class="form-row">
              ...
              <div class="form-group row my-0">
                    ...
                    <div class="form-group col-md-6 my-0">
                        <b><label for="userType">Loại:</label></b>
...
<div class="modal fade" id="editUser<?php echo $Id; ?>" tabindex="-1" role="dialog" aria-labelledby="editUser<?php echo $Id; ?>" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: rgb(111 202 203);">
        <h5 class="modal-title" id="editUser<?php echo $Id; ?>">ID Admin: <b><?php echo $Id; ?></b></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
            ...
            <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
                <div class="form-group col-md-8">
                    <form action="partials/_userManage.php" method="post" enctype="multipart/form-data">
                        <b><label for="image">Profile Ảnh</label></b>
                        <input type="file" name="userimage" id="userimage" accept=".jpg" class="form-control" required style="border:none;">
                        <small id="Info" class="form-text text-muted mx-3">Xin hãy upload file .jpg.</small>
                        <input type="hidden" id="userId" name="userId" value="<?php echo $Id; ?>">
                        <button type="submit" class="btn btn-success mt-3" name="updateProfilePhoto">Update Ảnh</button>
                    </form>         
                </div>
