    <header class="header" id="header">
        ...
        <div class="header__img">
            <img src="assetsForSideBar/img/me.png" alt="">
        </div>
    </header>
        ...
        <nav class="nav">
            <div>
                <a href="index.php" class="nav__logo">
                    ...
                    <span class="nav__logo-name">SaiGon Pizza</span>
                </a>
                ...
                <div class="nav__list">
                    ...
                    <a href="index.php?page=orderManage" class="nav-orderManage nav__link ">
                      ...
                      <span class="nav__name">Các đơn hàng</span>
                    </a>
                    <a href="index.php?page=categoryManage" class="nav__link nav-categoryManage">
                      <i class='bx bx-folder nav__icon' ></i>
                      <span class="nav__name">Các loại thực đơn</span>
                    </a>
