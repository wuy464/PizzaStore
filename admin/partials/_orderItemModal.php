    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color: rgb(111 202 203);">
                <h5 class="modal-title" id="orderItem<?php echo $orderid; ?>">Đặt (<b>ID đơn hàng: <?php echo $orderid; ?></b>)</h5>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    while($myrow = mysqli_fetch_assoc($myresult)){
                                        ...
                                        $pizzaName = isset($itemrow['pizzaName']) ? $itemrow['pizzaName'] : '';
                                        $pizzaPrice = isset($itemrow['pizzaPrice']) ? $itemrow['pizzaPrice'] : '';
                                        $pizzaDesc = isset($itemrow['pizzaDesc']) ? $itemrow['pizzaDesc'] : '';
                                        $pizzaCategorieId = isset($itemrow['pizzaCategorieId']) ? $itemrow['pizzaCategorieId'] : '';
