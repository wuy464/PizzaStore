                ...
                <form action="partials/_categoryManage.php" method="post" enctype="multipart/form-data">
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-md-12">
                                    <button type="submit" name="createCategory" class="btn btn-sm btn-primary col-sm-3 offset-md-4"> Tạo </button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <?php 
                            ...
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                echo '<tr>
                                        ...
                                        <td><img src="/OnlinePizzaDelivery/img/card-'.$catId. '.jpg" alt="Ảnh cho loại thực đơn" width="150px" height="150px"></td>
                                        <td>
                                            <p>Loại : <b>' .$catName. '</b></p>
                                            <p>Mô tả : <b class="truncate">' .$catDesc. '</b></p>
                                        </td>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: rgb(111 202 203);">
        <h5 class="modal-title" id="updateCat<?php echo $catId; ?>">ID loại Pizza: <b><?php echo $catId; ?></b></h5>
      ...
      <div class="modal-body">
        ...
        <form action="partials/_categoryManage.php" method="post">
            <div class="text-left my-2">
                <b><label for="name">Tên loại món</label></b>
