                ...
                if($loggedin){
                    ...
                    if($quaExistRows == 0) {
                        echo '<form action="partials/_manageCart.php" method="POST">
                              ...
                              <button type="submit" name="addToCart" class="btn btn-primary my-2">Thêm vào giỏ</button>';
                    }else {
                        echo '<a href="viewCart.php"><button class="btn btn-primary my-2">Đến giỏ hàng</button></a>';
                    }
                }
                else{
                    echo '<button class="btn btn-primary my-2" data-toggle="modal" data-target="#loginModal">Thêm vào giỏ</button>';
                }
                echo '</form>
                <h6 class="my-1"> Xem </h6>
                <div class="mx-4">
                    <a href="viewPizzaList.php?catid=' . $pizzaCategorieId . '" class="active text-dark">
                    <i class="fas fa-qrcode"></i>
                        <span>Tất cả Pizza</span>
                    </a>
                </div>
                <div class="mx-4">
