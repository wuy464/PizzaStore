...
<head>
    ...
    <title id="title">Mục Pizza</title>
...
<body>
    ...
    <div class="container my-3" id="cont">
        <div class="col-lg-4 text-center bg-light my-3" style="margin:auto;border-top: 2px groove black;border-bottom: 2px groove black;">     
            <h2 class="text-center"><span id="catTitle">Pizza</span></h2>
        </div>
        <div class="row">
        <?php
            $id = $_GET['catid'];
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                        <div class="card" style="width: 18rem;">
                            ...
                            echo '</form>                            
                                <a href="viewPizza.php?pizzaid=' . $pizzaId . '" class="mx-2"><button class="btn btn-primary">Xem chi tiết</button></a> 
                                </div>
                            </div>
                        </div>
                    </div>';
            ...
            if($noResult) {
                echo '<div class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <p class="display-4">Xin lỗi Trong danh mục này không có loại pizza này.</p>
                        <p class="lead"> Chúng tôi sẽ Update sớm nhất!.</p>
                    </div>
                </div> ';
            }
            ?>
