...
<body>
            ...
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-8">						
                        ...
                        <a href="#" onclick="window.print()" class="btn btn-info"><i class="material-icons">&#xE24D;</i> <span>In hóa đơn</span></a>
                    </div>
                </div>
            </div>
                    ...
                    <?php
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            ...
                            echo '<tr>
                                    ...
                                    <td><a href="#" data-toggle="modal" data-target="#orderItem' . $orderId . '" class="view" title="Xem chi tiết"><i class="material-icons">&#xE5C8;</i></a></td>
                                    
                                </tr>';
                        }
                        
                        if($counter==0) {
                            ?><script> document.getElementById("empty").innerHTML = '<div class="col-md-12 my-5"><div class="card"><div class="card-body cart"><div class="col-sm-12 empty-cart-cls text-center"> <img src="https://i.imgur.com/dCdflKN.png" width="130" height="130" class="img-fluid mb-4 mr-3"><h3><strong>Bạn chưa đặt món Pizza nào!.</strong></h3><h4>Thêm món gì đó để làm cho chúng ta hạnh phúc :)</h4> <a href="index.php" class="btn btn-primary cart-btn-transform m-3" data-abc="true">Tiếp tục shopping</a> </div></div></div></div>';</script> <?php
                        }
                    ?>
                </tbody>
            </table>
    ...
    <?php 
        ...
        <div class="alert alert-info my-3">
            <font style="font-size:22px"><center>Thanh toán đơn hàng, bạn cần phải <strong><a class="alert-link" data-toggle="modal" data-target="#loginModal">Login</a></strong></center></font>
        </div></div>';
    }
    ?>
